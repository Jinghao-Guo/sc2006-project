...
class ScoreCalculator:
    ...
    def _score_floor_area(self, floor_area, preference):
        ...
        if preference == '30-50':
            return 1.0 if 30 <= floor_area <= 50 else self._partial_area_score(floor_area, 30, 50)
        elif preference == '51-70':
            return 1.0 if 51 <= floor_area <= 70 else self._partial_area_score(floor_area, 51, 70)
        elif preference == '71-90':
            return 1.0 if 71 <= floor_area <= 90 else self._partial_area_score(floor_area, 71, 90)
        elif preference == '91-110':
            return 1.0 if 91 <= floor_area <= 110 else self._partial_area_score(floor_area, 91, 110)
        elif preference == '111-130':
            return 1.0 if 111 <= floor_area <= 130 else self._partial_area_score(floor_area, 111, 130)
        elif preference == '131-150':
            return 1.0 if 131 <= floor_area <= 150 else self._partial_area_score(floor_area, 131, 150)
        elif preference == '151+':
    ...
    def _score_price_range(self, price, preference):
        ...
        if preference == 'Under 200k':
            ...
            return 1.0 if 200000 <= price <= 300000 else self._partial_price_score(price, 200000, 300000)
        elif preference == '300k-400k':
            return 1.0 if 300000 <= price <= 400000 else self._partial_price_score(price, 300000, 400000)
        elif preference == '400k-500k':
            return 1.0 if 400000 <= price <= 500000 else self._partial_price_score(price, 400000, 500000)
        elif preference == '500k-600k':
            return 1.0 if 500000 <= price <= 600000 else self._partial_price_score(price, 500000, 600000)
        elif preference == '600k-700k':
            return 1.0 if 600000 <= price <= 700000 else self._partial_price_score(price, 600000, 700000)
        elif preference == '700k-800k':
            return 1.0 if 700000 <= price <= 800000 else self._partial_price_score(price, 700000, 800000)
        elif preference == '800k-1M':
            return 1.0 if 800000 <= price <= 1000000 else self._partial_price_score(price, 800000, 1000000)
